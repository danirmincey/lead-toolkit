...
(function(global) {
  ...
  var WordCloud = function WordCloud(elements, options) {
    ...
    var getRotateDeg = function getRotateDeg() {
      ...
      /* LEAD patch: rotationSteps === 2 -> only the two extreme angles
         (used for clean +/-90-degree vertical words). */
      if (settings.rotationSteps === 2) {
        return Math.random() < 0.5 ? minRotation : minRotation + rotationRange;
      }
